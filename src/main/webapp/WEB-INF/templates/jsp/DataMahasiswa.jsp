<%@page import="com.billqisuts.billqisindahutsP4.model.Mahasiswa"%>
<%@page import="java.util.List"%>
<%@page import="com.billqisuts.billqisindahutsP4.dao.MahasiswaDao"%>
<%@page import="com.billqisuts.billqisindahutsP4.database.KoneksiDatabase"%>
...
try {
		...
		try {
			...
			request.setAttribute("nim", ls.getNim());
                        request.setAttribute("nama", ls.getNama());
                        rowData += "<tr>"
                                    + "<td></td>"
                                    + "<td>"+(ls.getNim() != null ? ls.getNim() : "")+"</td>"
